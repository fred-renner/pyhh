...
def get(do_systs=False):
    ...
    ----------
    do_systs : bool
        make m_hh for all systematics histograms

    Returns
    -------
    tuple
        hists, collectedKinVars, collectedKinVarsWithRegions
    """
    ...
    return hists, collectedKinVars, collectedKinVarsWithRegions
